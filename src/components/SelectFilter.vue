...
<template>
  <div class="relative">
    ...
    >
      ...
      />
      <div class="mt-4 h-48 w-full overflow-y-auto text-xs lg:text-sm">
        <span
        ...
        <span
          ...
          @click="changeValue(item)"
          :class="[
            selectItem.id == item.id || (selectItem.id == '' && index == 0)
